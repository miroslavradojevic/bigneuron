 ...
 * NeuronFloater_plugin.h
 * 2015-5-11 : by Miroslav
 */
 
#ifndef __NEURONFLOATER_PLUGIN_H__
#define __NEURONFLOATER_PLUGIN_H__

#include <QtGui>
#include <v3d_interface.h>

class NeuronFloater : public QObject, public V3DPluginInterface2_1
{
	Q_OBJECT
